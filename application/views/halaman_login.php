...
<body class="bg-gradient" background="img/images.jpg" style="-webkit-background-size: cover;
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <img class="profile-img" src="template/img/" alt="" width="300px">
      
                                        <br>
                                        </br>

                                        <br>
                                        <h1 class="btn btn-warning btn-user btn-warning">
                                          login
                                     </h1 >
                                        <br>
                                        <br>
                                    ...
                                    <form class="user" action="<?=base_url('Login/proses_login') ?>" method="post">
                                        ...
                                        <button type="submit" class="btn-user btn btn-warning float-right">
                                            Masuk
                                        </button >
